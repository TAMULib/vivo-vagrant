...
Vagrant.configure('2') do |config|
  ...
  config.vm.provider 'hyperv' do |hv, override|
    ...
    override.vm.synced_folder 'provision', '/home/vagrant/provision', type: 'smb', mount_options: ['vers=3.0']
    override.vm.synced_folder 'src', '/home/vagrant/src', type: 'smb', mount_options: ['vers=3.0']
    override.vm.synced_folder 'work', '/work', type: 'smb', mount_options: ['vers=3.0']
  end
