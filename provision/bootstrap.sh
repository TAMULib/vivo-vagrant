...
installTomcat () {
  ...
  curl -O http://mirrors.sonic.net/apache/tomcat/tomcat-8/v8.5.41/bin/apache-tomcat-8.5.41.tar.gz

  mkdir /opt/tomcat || true
  tar xzvf apache-tomcat-8.5.41.tar.gz -C /opt/tomcat --strip-components=1
